...
namespace PixelForge.Assets.UserControls
{
    internal sealed class FlowPanel : Panel
    {
        ...
        private readonly List<UIElement> _visibleCache = [];
        private readonly Stack<FlowItemGroup> _groupPool = new();
        private readonly Stack<List<FlowItemGroup>> _listPool = new();
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            try
            {
                ...
                if (ResponsiveMode)
                {
                    Size infSize = new(finiteAw, double.PositiveInfinity);
        ...
        private static double CalculateMaxColumnHeight(List<FlowItemGroup> columns)
        {
            double max = 0;
